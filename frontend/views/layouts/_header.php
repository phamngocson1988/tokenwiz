    ...
    <div class="container">
      <div class="navbar-innr">
        <?php echo yii\widgets\Menu::widget([
          ...
          'items' => [
              // Add one more record
              ['label' => '<em class="ikon ikon-dashboard"></em> Đầu tư', 'url' => ['cart/index'], 'encode' => false],
              ...
              ['label' => '<em class="ikon ikon-coins"></em> Rút tiền', 'url' => ['withdrawal/index'], 'encode' => false, 'visible' => !Yii::$app->user->isGuest],
            ],
          ]);
        ?>
      </div>
